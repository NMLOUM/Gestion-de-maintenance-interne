        ...
        <div class="py-8">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                    ...
                    <!-- Tickets en retard -->
                    <div class="bg-white border-2 border-orange-400 rounded-lg shadow-lg p-6">
                        <div class="flex items-center justify-between">
                            <div>
                                <p class="text-gray-600 text-sm font-medium">Tickets en retard</p>
                                <p class="text-3xl font-bold text-orange-600">{{ overdueTickets?.length || 0 }}</p>
                                <p class="text-xs text-gray-500 mt-1">
                                    Dépassement SLA
                                </p>
                            </div>
